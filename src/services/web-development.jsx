  ...
  packages: [
    {
      ...
      price: "250",
      description:
        "Perfect for small businesses and startups looking to establish their online presence. Get a professional website with essential features to kickstart your digital journey.",
      services: [
    ...
    },
    {
      ...
      price: "350",
      description:
        "Ideal for growing businesses requiring advanced functionality and enhanced user experience. Get a feature-rich website with comprehensive digital solutions.",
      services: [
    ...
    },
    {
      ...
      price: "450",
      description:
        "Enterprise-level solution for businesses requiring comprehensive web presence. Get a fully customized website with advanced features and premium support.",
      services: [
