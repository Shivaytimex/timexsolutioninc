...
export const BackgroundBeamsWithCollision = ({ children }) => {
  ...
  return (
    <div
      ref={parentRef}
      className="h-full bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-full justify-center overflow-hidden mb-8"
    >
      {beams.map((beam) => (
        <CollisionMechanism
