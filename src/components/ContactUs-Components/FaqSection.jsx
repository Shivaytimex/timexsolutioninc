...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, we offer website design and development services to create responsive, user-friendly, and visually appealing websites. Our team ensures your site is optimized for performance, SEO, and a seamless user experience, tailored to your business objectives."
  },
  {
    question: "Can you help with content marketing strategies?",
    answer: "Our content marketing services include creating compelling blog posts, articles, infographics, videos, and other types of content. We focus on building your brand authority, driving traffic, and engaging your target audience through strategic storytelling."
  },
  {
    question: "What is your approach to paid advertising campaigns?",
    answer: "We take a strategic and data-driven approach to paid advertising, focusing on platforms like Google Ads, Facebook, and Instagram. Our campaigns are designed to maximize ROI through precise targeting, budget management, and continuous performance optimization."
  },
  {
    question: "Do you work with businesses of all sizes?",
    answer: "Yes, we work with startups, small businesses, and large enterprises across various industries. Our team tailors strategies to meet the unique needs and goals of each client, regardless of their size or budget."
  }
];
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-300 ${openIndex === index ? 'bg-purple-500' : 'bg-purple-600'}`}>
