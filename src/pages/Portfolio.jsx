  ...
  return (
    ...
    <section className="relative min-h-screen flex flex-col md:flex-row items-center justify-between bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 px-4 md:px-16 py-12">
      ...
      <div className="flex-1 flex flex-col items-center justify-center mt-12 md:mt-0 relative w-full md:w-auto">
        ...
        {/* Video Preview Card */}
        <div className="flex items-center bg-white/80 rounded-lg shadow-lg px-6 py-4 w-full max-w-xs">
          <div className="w-16 h-16 bg-gray-300 rounded flex items-center justify-center mr-4">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="10 8 16 12 10 16 10 8"/></svg>
          </div>
          <div>
        ...
        <div className="relative flex items-end justify-center min-h-[350px] md:min-h-[420px] w-full">
          ...
          <div className="relative z-20 flex flex-col items-center">
            ...
            <div className="flex items-center">
              <img src="/public/digital-marketing.webp" alt="Before" className="rounded-lg shadow-2xl w-72 md:w-96 border-4 border-white/10" />
              <img src="/public/digital-marketing-1.webp" alt="After" className="rounded-lg shadow-2xl w-72 md:w-96 border-4 border-cyan-400 ml-[-3rem]" style={{zIndex:1}} />
            </div>
          </div>
          {/* Right Side Image */}
